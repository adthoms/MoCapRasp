...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input", type=str, required=True, help="Path to the folder containing images."
    )
    parser.add_argument(
        "--output", type=str, required=True, help="Path to the output ROS bag file."
    )
    parser.add_argument(
        "--topic", type=str, default="/cam1/image_raw", help="ROS topic for the images."
    )
