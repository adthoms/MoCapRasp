...
class GPE(CaptureProcess):
    ...
    def estimate(self, datapath: str) -> None:
        """
        Estimates the ground plane from the captured data.
        Args:
            datapath (str): Path to the directory containing the captured data.
        """
        ...
        try:
            ...
            log.error(f"Failed to load estimation data from file: {e}")
            return

        log.info("Data successfully loaded. Starting estimation process...")
